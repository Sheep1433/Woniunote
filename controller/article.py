...
from common.redisdb import redis_article_zsort
...
def read(articleid):
    ...
    if dic['credit']:
        ...
        if not payed:
            ...
            dic['content'] = content[0:position]
    ...
    return render_template('article-user.html', article=dic, position=position, payed=payed, is_favorited=is_favorited,
